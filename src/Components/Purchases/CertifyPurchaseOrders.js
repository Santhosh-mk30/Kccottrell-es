    ...
    <html>
      <head>
        ...
        <style>
          ...
          /* ✅ Main body area */
          .print-body {
            margin: 10px 20px 10px 20px; /* space for header & footer */
            position: relative;
            z-index: 1;
          }
...
>
 ...
 <div ref={printRef} style={{ padding: 20 }}>
    ...
    >
      ...
      >
        ...
        <div style={{ borderRight: "1px solid #4a5568" }}>
          ...
          <table style={{ width: "100%", borderCollapse: "collapse", padding: 12,tableLayout: "fixed", }}>
            <tbody>
  <tr>
    <td style={{ padding: "5px", fontWeight: "bold", fontSize: "13px" }}>Supplier Name:</td>
    <td style={{ padding: "5px", fontSize: "13px" }}>{detailedData.supplier_name || "-"}</td>
  </tr>
  <tr>
    <td style={{ padding: "5px", fontWeight: "bold", fontSize: "13px" }}>Address:</td>
    <td style={{ padding: "5px", fontSize: "13px" }}>{detailedData.address || "-"}</td>
  </tr>
  {/* <tr>
    <td style={{ padding: "5px", fontWeight: "bold", fontSize: "13px" }}>Branch:</td>
    <td style={{ padding: "5px", fontSize: "13px" }}>{detailedData.branch_name || "-"}</td>
  </tr> */}
</tbody>
  ...
  <tr>
    <td style={{ padding: "5px", fontWeight: "bold", width: "40%", color: "#1a202c" }}>
      Order No:
    </td>
    <td style={{ padding: "5px" }}>{detailedData.order_no || "-"}</td>
  </tr>
  <tr>
   <td style={{ padding: "5px", fontWeight: "bold", color: "#1a202c" }}>
  Date:
</td>
<td style={{ padding: "5px" }}>
  {detailedData.purchase_date
    ? new Date(detailedData.purchase_date).toLocaleDateString("en-GB") // dd/mm/yyyy format
    : "-"}
</td>
  ...
  <tr>
    ...
    <td style={{ padding: "5px" }}>{detailedData.goods_services || "-"}</td>
  </tr>
  <tr>
    <td style={{ padding: "5px", fontWeight: "bold", color: "#1a202c" }}>
      Quantity:
    </td>
    <td style={{ padding: "5px" }}>{detailedData.qty || "-"}</td>
  </tr>
</tbody>
  ...
  <tr>
    ...
    <td style={{ padding: "3px" }}>{detailedData.supplier_contactPerson1|| "-"}</td>
  </tr>
  <tr>
    <td style={{ padding: "3px", fontWeight: "bold", color: "#1a202c" }}>
      Mobile No:
    </td>
    <td style={{ padding: "3px" }}>{detailedData.supplier_mobile1 || "-"}</td>
  </tr>
  <tr>
    <td style={{ padding: "3px", fontWeight: "bold", color: "#1a202c" }}>
      Email:
    </td>
    <td style={{ padding: "3px" }}>{detailedData.supplier_email1 || "-"}</td>
  </tr>
  <tr>
    <td style={{ padding: "3px", fontWeight: "bold", color: "#1a202c" }}>
      GST No:
    </td>
    <td style={{ padding: "3px" }}>{detailedData.supplier_gst1 || "-"}</td>
  </tr>
  <tr>
    <td style={{ padding: "3px", fontWeight: "bold", color: "#1a202c" }}>
      PAN No:
    </td>
    <td style={{ padding: "3px" }}>{detailedData.supplier_pan || "-"}</td>
  </tr>
</tbody>
        ...
        <div>
          ...
          <table style={{ width: "100%", borderCollapse: "collapse", padding: 12 }}>
           <tbody style={{ fontSize: "15px", color: "#333", lineHeight: "1.4" }}>
  <tr>
    <td style={{ padding: "3px", fontWeight: "bold", width: "40%", color: "#333" }}>
      Contact Person:
    </td>
    <td style={{ padding: "3px" }}>{detailedData.purchaser_contactPerson2 || "-"}</td>
  </tr>
  <tr>
    <td style={{ padding: "3px", fontWeight: "bold", color: "#333" }}>
      Mobile No:
    </td>
    <td style={{ padding: "3px" }}>{detailedData.purchaser_mobile2 || "-"}</td>
  </tr>
  <tr>
    <td style={{ padding: "3px", fontWeight: "bold", color: "#333" }}>
      Email:
    </td>
    <td style={{ padding: "3px" }}>{detailedData.purchaser_email2 || "-"}</td>
  </tr>
  <tr>
    <td style={{ padding: "3px", fontWeight: "bold", color: "#333" }}>
      GST No:
    </td>
    <td style={{ padding: "3px" }}>{detailedData.purchaser_gst2 || "-"}</td>
  </tr>
  <tr>
    <td style={{ padding: "3px", fontWeight: "bold", color: "#333" }}>
      PAN No:
    </td>
    <td style={{ padding: "3px" }}>{detailedData.purchaser_pan2 || "-"}</td>
  </tr>
</tbody>
      ...
      <div style={{ borderTop: "1px solid #4a5568" }}>
        ...
        <div style={{ padding: "10px", fontSize: 14, lineHeight: 1.6, color: "#333" }}>
...
>
  ...
  {detailedData.delivery_date
    ? new Date(detailedData.delivery_date).toLocaleDateString("en-GB") // 👉 Converts to dd/mm/yyyy
    : "-"}{" "}
  @ {detailedData.delivery_time || "-"}
</p>
  ...
  >
    ...
    <div style={{ width: "45%", textAlign: "left" }}>
      ...
      <div style={{ marginTop: "60px" }}>
        ...
        <p style={{ marginBottom: "2px" }}>Director</p>
      </div>
    </div>
